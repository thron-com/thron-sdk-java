...
class MResourceFile extends Serializable {
	...
	@BeanProperty 
	var name: String =_
	def withname(p:String):MResourceFile ={ 	this.name = p; 	this }

	//#SWG#@ApiModelProperty(value = """""" ,required = true)
	@BeanProperty 
	var isFolder: Boolean =_
	def withisFolder(p:Boolean):MResourceFile ={ 	this.isFolder = p; 	this }
	...
	@BeanProperty 
	var size: Long =_
	def withsize(p:Long):MResourceFile ={ 	this.size = p; 	this }

	//#SWG#@ApiModelProperty(value = """""" ,required = true)
	@BeanProperty 
	var url: String =_
	def withurl(p:String):MResourceFile ={ 	this.url = p; 	this }
