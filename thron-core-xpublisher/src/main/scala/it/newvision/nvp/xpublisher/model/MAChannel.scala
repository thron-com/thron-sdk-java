...
abstract class MAChannel extends Serializable {
	...
	def withurlContent(p:String):this.type ={ 	this.urlContent = p; 	this }
	...
	def withurlDescriptor(p:String):this.type ={ 	this.urlDescriptor = p; 	this }
	...
	def withstatus(p:MEChannelStatus):this.type ={ 	this.status = p; 	this }
	...
	def withplannedDate(p:Date):this.type ={ 	this.plannedDate = p; 	this }
	...
	def withdescriptorMimeType(p:String):this.type ={ 	this.descriptorMimeType = p; 	this }
	...
	var defaultThumb: MThumbnail =_
	  def withdefaultThumb(p:MThumbnail):this.type ={ 	this.defaultThumb = p; 	this }
