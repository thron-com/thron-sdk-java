...
class MWowzaEventConfData extends Serializable {
	...
	def withclientStreamsWithPassword(p:List[MWowzaStreamCredential]):this.type ={ 	this.clientStreamsWithPassword = p; 	this }
	...
	def withstartRecordingOnPublish(p:Boolean):this.type ={ 	this.startRecordingOnPublish = p; 	this }
	...
	def withwowzaEventId(p:String):this.type ={ 	this.wowzaEventId = p; 	this }
