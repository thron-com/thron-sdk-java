...
public enum MEContentStatus {
	...
	/**
	 * if there exists a channel that has a publishing or unpublishing process in
	 * progress.
	 */
	//#SWG#@ApiModelProperty(value = """if there exists a channel that has a publishing or unpublishing process in progress.""")
