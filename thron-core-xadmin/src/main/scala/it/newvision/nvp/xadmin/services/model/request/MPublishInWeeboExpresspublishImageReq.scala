...
class MPublishInWeeboExpresspublishImageReq extends Serializable {
	...
	def withclientId(p:String):MPublishInWeeboExpresspublishImageReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var param: MPublishImageParams =_
	def withparam(p:MPublishImageParams):MPublishInWeeboExpresspublishImageReq ={ 	this.param = p; 	this }
