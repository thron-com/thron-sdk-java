...
class MPublishingProcessremoveChannelReq extends Serializable {
	...
	def withclientId(p:String):MPublishingProcessremoveChannelReq ={ 	this.clientId = p; 	this }
	...
	def withmediaContentId(p:String):MPublishingProcessremoveChannelReq ={ 	this.mediaContentId = p; 	this }
	...
	def withxcontentId(p:String):MPublishingProcessremoveChannelReq ={ 	this.xcontentId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var channel: String =_
	def withchannel(p:String):MPublishingProcessremoveChannelReq ={ 	this.channel = p; 	this }
