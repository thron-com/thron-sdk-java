...
class MPublishingProcesscreateContentForChannelReq extends Serializable {
	...
	def withclientId(p:String):MPublishingProcesscreateContentForChannelReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var param: MCreateContentForChannelParams =_
	def withparam(p:MCreateContentForChannelParams):MPublishingProcesscreateContentForChannelReq ={ 	this.param = p; 	this }
