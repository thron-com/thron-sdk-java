...
class MMediaContentAdminfindMediaContentByPropertiesReq extends Serializable {
	...
	def withclientId(p:String):MMediaContentAdminfindMediaContentByPropertiesReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var criteria: MMediaContentCriteria =_
	def withcriteria(p:MMediaContentCriteria):MMediaContentAdminfindMediaContentByPropertiesReq ={ 	this.criteria = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var offset: Integer =_
	def withoffset(p:Integer):MMediaContentAdminfindMediaContentByPropertiesReq ={ 	this.offset = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var numberOfResult: Integer =_
	def withnumberOfResult(p:Integer):MMediaContentAdminfindMediaContentByPropertiesReq ={ 	this.numberOfResult = p; 	this }
