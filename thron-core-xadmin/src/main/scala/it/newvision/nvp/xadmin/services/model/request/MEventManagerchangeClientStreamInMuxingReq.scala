...
class MEventManagerchangeClientStreamInMuxingReq extends Serializable {
	...
	def withclientId(p:String):MEventManagerchangeClientStreamInMuxingReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var mediaContentId: String =_
	def withmediaContentId(p:String):MEventManagerchangeClientStreamInMuxingReq ={ 	this.mediaContentId = p; 	this }
	...
	def withclientStreamInMuxing(p:String):MEventManagerchangeClientStreamInMuxingReq ={ 	this.clientStreamInMuxing = p; 	this }
