...
****************************/
@XmlRootElement(name="MResponseGetContentTypes") 
@XmlType(name="MResponseGetContentTypes")
//#SWG#@ApiModel(description = """""")
class MResponseGetContentTypes extends MResponsePublishWeebo with Serializable  {
