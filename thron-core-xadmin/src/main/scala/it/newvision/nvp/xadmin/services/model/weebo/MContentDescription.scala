...
class MContentDescription extends Serializable {
	...
	@BeanProperty 
	var name: String =_
	def withname(p:String):MContentDescription ={ 	this.name = p; 	this }
	...
	def withdescription(p:String):MContentDescription ={ 	this.description = p; 	this }
	...
	def withexcerpt(p:String):MContentDescription ={ 	this.excerpt = p; 	this }
	...
	def withprettyId(p:String):MContentDescription ={ 	this.prettyId = p; 	this }
	...
	@BeanProperty 
	var locale: String =_
	def withlocale(p:String):MContentDescription ={ 	this.locale = p; 	this }
	...
	def withcategoryId(p:String):MContentDescription ={ 	this.categoryId = p; 	this }
	...
	@BeanProperty 
	var tags: String =_
	def withtags(p:String):MContentDescription ={ 	this.tags = p; 	this }
	...
	var userId: String =_
	@Deprecated
	def withuserId(p:String):MContentDescription ={ 	this.userId = p; 	this }
	...
	@BeanProperty 
	var owner: String =_
	def withowner(p:String):MContentDescription ={ 	this.owner = p; 	this }
	...
	@Deprecated
	def withmetadata(p:List[MContentMetadata]):MContentDescription ={ 	this.metadata = p; 	this }
	...
	def withproperties(p:List[String]):MContentDescription ={ 	this.properties = p; 	this }
