...
****************************/
/**
 * Request message for service JContent.getContentTypes
 */
@XmlRootElement(name="MContentgetContentTypesReq")
@XmlType(name="MContentgetContentTypesReq")
//#SWG#@ApiModel(description = "Request message for service JContent.getContentTypes")
class MContentgetContentTypesReq extends Serializable {
