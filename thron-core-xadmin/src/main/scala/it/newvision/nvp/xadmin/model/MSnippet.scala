...
class MSnippet extends Serializable {
	...
	def withid(p:String):MSnippet ={ 	this.id = p; 	this }
	...
	def withstatus(p:MESnippetStatus):MSnippet ={ 	this.status = p; 	this }
	...
	def withversion(p:String):MSnippet ={ 	this.version = p; 	this }
	...
	def withsnippetType(p:String):MSnippet ={ 	this.snippetType = p; 	this }

	//#SWG#@ApiModelProperty(value = """""")
	@BeanProperty 
	var templateId: String =_
	def withtemplateId(p:String):MSnippet ={ 	this.templateId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""")
	@BeanProperty 
	var templateVersion: String =_
	def withtemplateVersion(p:String):MSnippet ={ 	this.templateVersion = p; 	this }
	...
	def withownerUsername(p:String):MSnippet ={ 	this.ownerUsername = p; 	this }
	...
	def withownerFullName(p:String):MSnippet ={ 	this.ownerFullName = p; 	this }

	//#SWG#@ApiModelProperty(value = """""")
	@BeanProperty 
	var lastUpdate: Date =_
	def withlastUpdate(p:Date):MSnippet ={ 	this.lastUpdate = p; 	this }
	...
	def withconfigData(p:String):MSnippet ={ 	this.configData = p; 	this }
	...
	def withmetadata(p:List[MMetadata]):MSnippet ={ 	this.metadata = p; 	this }
	...
	def withdisplayName(p:String):MSnippet ={ 	this.displayName = p; 	this }
	...
	def withdescription(p:String):MSnippet ={ 	this.description = p; 	this }
