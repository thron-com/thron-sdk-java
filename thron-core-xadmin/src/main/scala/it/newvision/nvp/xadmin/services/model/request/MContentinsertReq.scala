...
****************************/
/**
 * Request message for service JContent.insert
 */
@XmlRootElement(name="MContentinsertReq")
@XmlType(name="MContentinsertReq")
//#SWG#@ApiModel(description = "Request message for service JContent.insert")
class MContentinsertReq extends Serializable {

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var param: MPublishParams =_
	def withparam(p:MPublishParams):this.type ={ 	this.param = p; 	this }
