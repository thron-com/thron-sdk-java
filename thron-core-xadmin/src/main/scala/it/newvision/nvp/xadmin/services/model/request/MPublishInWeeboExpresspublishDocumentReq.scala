...
class MPublishInWeeboExpresspublishDocumentReq extends Serializable {
	...
	def withclientId(p:String):MPublishInWeeboExpresspublishDocumentReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var param: MPublishExpressDocumentParams =_
	def withparam(p:MPublishExpressDocumentParams):MPublishInWeeboExpresspublishDocumentReq ={ 	this.param = p; 	this }
