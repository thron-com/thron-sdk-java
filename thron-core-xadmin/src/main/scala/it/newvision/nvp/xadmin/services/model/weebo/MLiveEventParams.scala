...
class MLiveEventParams extends Serializable {
	...
	def withstreamName(p:String):MLiveEventParams ={ 	this.streamName = p; 	this }

	//#SWG#@ApiModelProperty(value = """""")
	@BeanProperty 
	var owner: String =_
	def withowner(p:String):MLiveEventParams ={ 	this.owner = p; 	this }
	...
	def withstartDate(p:Date):MLiveEventParams ={ 	this.startDate = p; 	this }
	...
	@BeanProperty 
	var endDate: Date =_
	def withendDate(p:Date):MLiveEventParams ={ 	this.endDate = p; 	this }
	...
	def withneverEndingLiveEvent(p:Boolean):MLiveEventParams ={ 	this.neverEndingLiveEvent = p; 	this }
