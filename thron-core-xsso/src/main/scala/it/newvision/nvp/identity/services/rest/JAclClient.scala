 ...
 * </ul>
 */
class JAclClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def getAclDetail(tokenId: String, 
			param: MAclgetAclDetailReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclDetail ={
	...
	*/
	def addAclRules(tokenId: String, 
			param: MAcladdAclRulesReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclUpdate ={
	...
	*/
	def verifyAclRule(tokenId: String, 
			param: MAclverifyAclRuleReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclVerify ={
	...
	*/
	def deleteAclRules(tokenId: String, 
			param: MAcldeleteAclRulesReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclUpdate ={
