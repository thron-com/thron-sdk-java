...
class MVUserManagerupdateSettingsReq extends Serializable {
	...
	def withclientId(p:String):MVUserManagerupdateSettingsReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var username: String =_
	def withusername(p:String):MVUserManagerupdateSettingsReq ={ 	this.username = p; 	this }
	...
	def withsettings(p:MVUserSettings):MVUserManagerupdateSettingsReq ={ 	this.settings = p; 	this }
