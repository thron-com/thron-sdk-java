...
class MVUserManagerchangeUserStatusReq extends Serializable {
	...
	def withclientId(p:String):MVUserManagerchangeUserStatusReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var username: String =_
	def withusername(p:String):MVUserManagerchangeUserStatusReq ={ 	this.username = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var properties: MVUserProperties =_
	def withproperties(p:MVUserProperties):MVUserManagerchangeUserStatusReq ={ 	this.properties = p; 	this }
