 ...
 * </ul>
 */
@XmlRootElement(name="MGroupFieldsOption") 
@XmlType(name="MGroupFieldsOption")
...
//#SWGNL#</ul>""")
class MGroupFieldsOption extends Serializable {

	//#SWG#@ApiModelProperty(value = """""")
	@BeanProperty 
	var returnOwnAcl: Boolean  = false
	def withreturnOwnAcl(p:Boolean):MGroupFieldsOption ={ 	this.returnOwnAcl = p; 	this }

	//#SWG#@ApiModelProperty(value = """""")
	@BeanProperty 
	var returnItags: Boolean  = false
	def withreturnItags(p:Boolean):MGroupFieldsOption ={ 	this.returnItags = p; 	this }

	//#SWG#@ApiModelProperty(value = """""")
	@BeanProperty 
	var returnImetadata: Boolean  = false
	def withreturnImetadata(p:Boolean):MGroupFieldsOption ={ 	this.returnImetadata = p; 	this }
