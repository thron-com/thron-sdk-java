 ...
 * </ul>
 */
class JCategoryClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def createCategory(tokenId: String, 
			param: MCategorycreateCategoryReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseNewCategory ={
	...
	*/
	def addCategory4Locale(tokenId: String, 
			param: MCategoryaddCategory4LocaleReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseUpdateCategory ={
	...
	*/
	def removeCategory4Locale(tokenId: String, 
			param: MCategoryremoveCategory4LocaleReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseUpdateCategory ={
	...
	*/
	def updateCategory4Locale(tokenId: String, 
			param: MCategoryupdateCategory4LocaleReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseUpdateCategory ={
	...
	*/
	def removeCategory(tokenId: String, 
			clientId: String, 
			catId: String, 
			cascade: Boolean)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseRemoveCategory ={
	...
	*/
	def findByProperties2(tokenId: String, 
			param: MCategoryfindByProperties2Req)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseFindCategory2 ={
	...
	*/
	def updateCategory(tokenId: String, 
			param: MCategoryupdateCategoryReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseUpdateCategory ={
	...
	*/
	def getCategory(tokenId: String, 
			...
			categoryId: String, 
			cascade: Boolean, 
			locale: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseGetCategory ={
	...
	*/
	def addCategoryPrettyId(tokenId: String, 
			param: MCategoryaddCategoryPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCategoryPrettyId ={
	...
	*/
	def updateCategoryPrettyId(tokenId: String, 
			param: MCategoryupdateCategoryPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCategoryPrettyId ={
	...
	*/
	def removeCategoryPrettyId(tokenId: String, 
			param: MCategoryremoveCategoryPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCategoryPrettyId ={
	...
	*/
	def verifyCategoryPrettyId(tokenId: String, 
			clientId: String, 
			param: MCategoryverifyCategoryPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCategoryVerifyPrettyId ={
	...
	*/
	def move(tokenId: String, 
			clientId: String, 
			sourceId: String, 
			targetId: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCategory ={
