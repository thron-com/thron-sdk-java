...
class MContentCategoryshowContentsByCategoryReq extends Serializable {
	...
	def withclient(p:MCredential):MContentCategoryshowContentsByCategoryReq ={ 	this.client = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var categoryId: String =_
	def withcategoryId(p:String):MContentCategoryshowContentsByCategoryReq ={ 	this.categoryId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var contentsCriteria: MContentCriteria =_
	def withcontentsCriteria(p:MContentCriteria):MContentCategoryshowContentsByCategoryReq ={ 	this.contentsCriteria = p; 	this }
	...
	@BeanProperty
	var locale: String =_
	def withlocale(p:String):MContentCategoryshowContentsByCategoryReq ={ 	this.locale = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var offset: Integer =_
	def withoffset(p:Integer):MContentCategoryshowContentsByCategoryReq ={ 	this.offset = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var numberOfResult: Integer =_
	def withnumberOfResult(p:Integer):MContentCategoryshowContentsByCategoryReq ={ 	this.numberOfResult = p; 	this }
