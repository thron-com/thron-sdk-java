 ...
 * </ul>
 */
class JCuePointClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def getCuePoints(tokenId: String, 
			param: MCuePointgetCuePointsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseGetCuePoints ={
	...
	*/
	def addCuePoints(tokenId: String, 
			param: MCuePointaddCuePointsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAddCuePoints ={
	...
	*/
	def updateCuePoint(tokenId: String, 
			param: MCuePointupdateCuePointReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCuePoint ={
	...
	*/
	def removeCuePoints(tokenId: String, 
			param: MCuePointremoveCuePointsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCuePoint ={
	...
	*/
	def uploadSrtFile(tokenId: String, 
			param: MCuePointuploadSrtFileReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCuePoint ={
