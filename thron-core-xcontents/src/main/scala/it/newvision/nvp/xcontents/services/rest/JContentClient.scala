...
class JContentClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def search(tokenId: String, 
			clientId: String, 
			param: MContentsearchReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MContentSearchResult ={
	...
	*/
	def addContent4Locale(tokenId: String, 
			param: MContentaddContent4LocaleReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentAddLocale ={
	...
	*/
	def detail(tokenId: String, 
			...
			pkey: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentDetail ={
	...
	*/
	def removeContent4Locale(tokenId: String, 
			clientId: String, 
			contentId: String, 
			locale: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentRemoveLocale ={
	...
	*/
	def findByProperties(tokenId: String, 
			param: MContentfindByPropertiesReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentFindByProperties ={
	...
	*/
	def updateContent(tokenId: String, 
			param: MContentupdateContentReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentUpdate ={
	...
	*/
	def updateContent4Locale(tokenId: String, 
			param: MContentupdateContent4LocaleReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentUpdateLocale ={
	...
	*/
	def updateContentPrettyId(tokenId: String, 
			param: MContentupdateContentPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentPrettyId ={
	...
	*/
	def removeContentPrettyId(tokenId: String, 
			param: MContentremoveContentPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentPrettyId ={
	...
	*/
	def addContentPrettyId(tokenId: String, 
			param: MContentaddContentPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentPrettyId ={
	...
	*/
	def verifyContentPrettyId(tokenId: String, 
			clientId: String, 
			param: MContentverifyContentPrettyIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentVerifyPrettyId ={
	...
	*/
	def addLinkedContent(tokenId: String, 
			param: MContentaddLinkedContentReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContent ={
	...
	*/
	def addLinkedContents(tokenId: String, 
			param: MContentaddLinkedContentsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContent ={
	...
	*/
	def moveLinkedContent(tokenId: String, 
			param: MContentmoveLinkedContentReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContent ={
	...
	*/
	def removeLinkedContents(tokenId: String, 
			param: MContentremoveLinkedContentsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContent ={
	...
	*/
	def addExternalId(tokenId: String, 
			clientId: String, 
			contentId: String, 
			param: MContentaddExternalIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentUpdate ={
	...
	*/
	def removeExternalId(tokenId: String, 
			clientId: String, 
			contentId: String, 
			param: MContentremoveExternalIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentUpdate ={
	...
	*/
	def verifyExternalId(tokenId: String, 
			clientId: String, 
			param: MContentverifyExternalIdReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseContentVerifyExternalId ={
