 ...
 * </ul>
 */
class JSubscriptionsClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def categorySubscription(tokenId: String, 
			param: MSubscriptionscategorySubscriptionReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseSubscription ={
	...
	*/
	def categoriesSubscription(tokenId: String, 
			param: MSubscriptionscategoriesSubscriptionReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseCategoriesSubscription ={
