 ...
 * </ul>
 */
class JAclInverseRulesClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def list(tokenId: String, 
			clientId: String, 
			targetObjId: String, 
			param: MAclInverseRuleslistReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclInverseList ={
	...
	*/
	def insert(tokenId: String, 
			clientId: String, 
			param: MAclInverseRulesinsertReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclInverseUpdate ={
	...
	*/
	def remove(tokenId: String, 
			clientId: String, 
			param: MAclInverseRulesremoveReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclInverseUpdate ={
	...
	*/
	def verify(tokenId: String, 
			clientId: String, 
			param: MAclInverseRulesverifyReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclInverseVerify ={
