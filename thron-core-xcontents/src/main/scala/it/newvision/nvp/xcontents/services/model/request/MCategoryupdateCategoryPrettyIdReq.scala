...
class MCategoryupdateCategoryPrettyIdReq extends Serializable {
	...
	def withclientId(p:String):MCategoryupdateCategoryPrettyIdReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var categoryId: String =_
	def withcategoryId(p:String):MCategoryupdateCategoryPrettyIdReq ={ 	this.categoryId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var prettyId: MPrettyId =_
	def withprettyId(p:MPrettyId):MCategoryupdateCategoryPrettyIdReq ={ 	this.prettyId = p; 	this }
