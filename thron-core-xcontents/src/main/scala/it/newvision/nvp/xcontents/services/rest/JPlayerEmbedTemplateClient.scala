 ...
 * </ul>
 */
class JPlayerEmbedTemplateClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def list(tokenId: String, 
			clientId: String, 
			param: MPlayerEmbedTemplatelistReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateList ={
	...
	*/
	def listVersions(tokenId: String, 
			clientId: String, 
			id: String, 
			param: MPlayerEmbedTemplatelistVersionsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateListVersion ={
	...
	*/
	def detail(tokenId: String, 
			clientId: String, 
			id: String, 
			version: Integer)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateDetail ={
	...
	*/
	def insert(tokenId: String, 
			clientId: String, 
			param: MPlayerEmbedTemplateinsertReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateDetail ={
	...
	*/
	def remove(tokenId: String, 
			clientId: String, 
			templateId: String, 
			param: MPlayerEmbedTemplateremoveReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbed ={
	...
	*/
	def update(tokenId: String, 
			clientId: String, 
			id: String, 
			param: MPlayerEmbedTemplateupdateReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateDetail ={
	...
	*/
	def createVersion(tokenId: String, 
			clientId: String, 
			id: String, 
			param: MPlayerEmbedTemplatecreateVersionReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateVersionDetail ={
	...
	*/
	def addRoles(tokenId: String, 
			clientId: String, 
			id: String, 
			param: MPlayerEmbedTemplateaddRolesReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateDetail ={
	...
	*/
	def removeRoles(tokenId: String, 
			clientId: String, 
			id: String, 
			param: MPlayerEmbedTemplateremoveRolesReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayerEmbedTemplateDetail ={
