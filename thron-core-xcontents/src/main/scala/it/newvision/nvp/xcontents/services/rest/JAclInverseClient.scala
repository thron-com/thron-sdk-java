 ...
 * </ul>
 */
class JAclInverseClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def getAclDetail(tokenId: String, 
			param: MAclInversegetAclDetailReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclDetailInverse ={
	...
	*/
	def addAclRules(tokenId: String, 
			param: MAclInverseaddAclRulesReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclUpdate ={
	...
	*/
	def verifyAclRule(tokenId: String, 
			param: MAclInverseverifyAclRuleReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclVerify ={
	...
	*/
	def deleteAclRules(tokenId: String, 
			param: MAclInversedeleteAclRulesReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseAclUpdate ={
