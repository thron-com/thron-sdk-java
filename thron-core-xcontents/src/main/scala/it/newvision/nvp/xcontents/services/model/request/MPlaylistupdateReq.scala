...
class MPlaylistupdateReq extends Serializable {
	...
	def withclientId(p:String):MPlaylistupdateReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var xcontentId: String =_
	def withxcontentId(p:String):MPlaylistupdateReq ={ 	this.xcontentId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var xcontentList: MContentList =_
	def withxcontentList(p:MContentList):MPlaylistupdateReq ={ 	this.xcontentList = p; 	this }
	...
	def withcategoryIdForAcl(p:String):MPlaylistupdateReq ={ 	this.categoryIdForAcl = p; 	this }
