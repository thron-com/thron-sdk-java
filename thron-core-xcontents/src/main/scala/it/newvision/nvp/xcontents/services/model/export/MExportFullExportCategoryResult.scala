...
****************************/
@XmlRootElement(name="MExportFullExportCategoryResult") 
@XmlType(name="MExportFullExportCategoryResult")
//#SWG#@ApiModel(description = """""")
class MExportFullExportCategoryResult extends Serializable {
