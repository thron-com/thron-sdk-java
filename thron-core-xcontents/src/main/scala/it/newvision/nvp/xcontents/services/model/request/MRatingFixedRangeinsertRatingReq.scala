...
class MRatingFixedRangeinsertRatingReq extends Serializable {
	...
	def withclientId(p:String):MRatingFixedRangeinsertRatingReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var contentId: String =_
	def withcontentId(p:String):MRatingFixedRangeinsertRatingReq ={ 	this.contentId = p; 	this }
	...
	@BeanProperty
	var score: Double =_
	def withscore(p:Double):MRatingFixedRangeinsertRatingReq ={ 	this.score = p; 	this }
	...
	@BeanProperty
	var userId: String =_
	def withuserId(p:String):MRatingFixedRangeinsertRatingReq ={ 	this.userId = p; 	this }
	...
	def withcategoryIdForAcl(p:String):MRatingFixedRangeinsertRatingReq ={ 	this.categoryIdForAcl = p; 	this }
