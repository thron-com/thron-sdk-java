...
class MTextCriteria extends Serializable {
	...
	/**
	 * Used to perform a free-text search on the defined attribute.
	 */
	//#SWG#@ApiModelProperty(value = """Used to perform a free-text search on the defined attribute.""" ,required = true)
	@BeanProperty 
	var text: String =_
