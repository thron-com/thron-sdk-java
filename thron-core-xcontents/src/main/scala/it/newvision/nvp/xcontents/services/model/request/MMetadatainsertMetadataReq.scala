...
****************************/
/**
 * Request message for service JMetadata.insertMetadata
 */
@XmlRootElement(name="MMetadatainsertMetadataReq")
@XmlType(name="MMetadatainsertMetadataReq")
//#SWG#@ApiModel(description = "Request message for service JMetadata.insertMetadata")
class MMetadatainsertMetadataReq extends Serializable {
