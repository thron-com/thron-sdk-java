 ...
 * </ul>
 */
class JDeliveryClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def getContentDetail(tokenId: String, 
			...
			pkey: String, 
			lcid: String, 
			embedCodeId: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseDeliveryGetContentDetail ={
	...
	*/
	def getPlayListDescriptor(tokenId: String, 
			...
			clientIPv6: String, 
			userAgent: String, 
			authServiceForCallback: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePlayListDescriptor ={
		try{
					val webResource = JDeliveryClient.client.resource(this.resourceEndpoint)
					val params = new com.sun.jersey.core.util.MultivaluedMapImpl
					Option(clientId).foreach(s => params.add("clientId", s))
	...
	*/
	def getCuePoints(tokenId: String, 
			...
			numberOfResult: Integer, 
			pkey: String, 
			lcid: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseDeliveryGetCuePoints ={
	...
	*/
	def getSubTitles(tokenId: String, 
			...
			locale: String, 
			pkey: String, 
			lcid: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):String ={
	...
	*/
	def getDownloadableContents(tokenId: String, 
			...
			divArea: String, 
			offset: Integer, 
			numberOfResult: Integer)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseDeliveryGetDownloadableContents ={
	...
	*/
	def getRecommendedContents(tokenId: String, 
			...
			divArea: String, 
			offset: Integer, 
			numberOfResult: Integer)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseDeliveryGetRecommendedContents ={
	...
	*/
	def getPlaylistContents(tokenId: String, 
			...
			divArea: String, 
			offset: Integer, 
			numberOfResult: Integer)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseDeliveryGetPlaylistContents ={
