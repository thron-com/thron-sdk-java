 ...
 * </ul>
 */
class JArchiveClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def download(tokenId: String, 
			...
			saveAs: String, 
			contactId: String, 
			trackEvent: Boolean)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):java.io.File ={
		...
		Option(trackEvent).foreach(s => params.add("trackEvent", s))  
	...
	*/
	def prepare(tokenId: String, 
			clientId: String, 
			param: MArchiveprepareReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponsePrepareArchive ={
	...
	*/
	def downloadPlayerEmbedTemplate(tokenId: String, 
			clientId: String, 
			templateId: String, 
			templateVersion: Integer)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):java.io.File ={
