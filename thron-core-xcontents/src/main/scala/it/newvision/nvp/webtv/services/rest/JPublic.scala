 ...
 */
@Path("/public")
//#SWG#@Api(value = "/public", description = """This service is optimized for the delivery of public resources
//#SWGNL#
...
trait JPublic extends it.newvision.nvp.core.libraries.restserver.BaseResource {
	...
	*/
	...
	//#SWG#@ApiOperation(value = "/pagelet", notes = """This service provides the image of a given IMAGE content with the desired resolution and quality: THRON will automatically process the highest available quality image to apply cropping and resize algorithms that match your request, as specified by URL parameters expressed after ContentID. 
	...
	@PathParam("clientId")
	clientId: String, 
			//#SWG#@ApiParam(value = """The xcontentId (no prettyId or externalId) of the content
	//#SWGNL#""")
	@PathParam("id")
	id: String, 
	...
	*/
	...
	@Produces(Array(MediaType.WILDCARD,"application/x-javascript"))
	//#SWG#@ApiOperation(value = "/document", notes = """This service provides the document of a given OTHER content with the desired resolution and quality: THRON will automatically process the highest available quality image to apply cropping and resize algorithms that match your request, as specified by URL parameters expressed after ContentID. 
	//#SWGNL#For backward compatibility, if no additional query param is provided, the service will return the image of the exact width of the divArea while height will respect the aspect ratio.
	//#SWGNL#HTTP status codes: 
	//#SWGNL#<ul>
	//#SWGNL#	<li>400: invalid arguments,</li>
	...
	*/
	...
	@Produces(Array(MediaType.WILDCARD,"application/x-javascript"))
	//#SWG#@ApiOperation(value = "/audio", notes = """This service provides the audio source of a given AUDIO content with the desired resolution and quality: THRON will automatically process the highest available quality image to apply cropping and resize algorithms that match your request, as specified by URL parameters expressed after ContentID. 
	//#SWGNL#For backward compatibility, if no additional query param is provided, the service will return the image of the exact width of the divArea while height will respect the aspect ratio.
	//#SWGNL#HTTP status codes: 
	//#SWGNL#<ul>
	//#SWGNL#	<li>400: invalid arguments,</li>
	...
	*/
	...
	@Produces(Array(MediaType.WILDCARD,"application/x-javascript"))
	//#SWG#@ApiOperation(value = "/video", notes = """NOT DOCUMENTED IN DEVELOPER PORTAL.
	//#SWGNL#Protected by deliveryToken
	//#SWGNL#
	//#SWGNL#This service provides the video source of a given VIDEO content with the desired resolution and quality: THRON will automatically process the highest available quality image to apply cropping and resize algorithms that match your request, as specified by URL parameters expressed after ContentID. 
	//#SWGNL#For backward compatibility, if no additional query param is provided, the service will return the image of the exact width of the divArea while height will respect the aspect ratio.
	//#SWGNL#HTTP status codes: 
	//#SWGNL#<ul>
	//#SWGNL#	<li>400: invalid arguments,</li>
	...
	*/
	...
	croph: Double,
		...
		try{	
			val resp = this.__image(PRestHelper.getTokenId(tokenId_q, tokenId),clientId,id,pkey,preset,divArea,prettyName,lcid,scalemode,quality,cropmode,cropx,cropy,cropw,croph)
	...
	/** ABSTRACT METHOD TO IMPLEMENT */ 
	 protected def __image(tokenId: String, clientId: String, id: String, pkey: String, preset: String, divArea: String, prettyName: String, lcid: String, scalemode: String, quality: Integer, cropmode: String, cropx: Double, cropy: Double, cropw: Double, croph: Double) :java.io.File
	/** ABSTRACT METHOD. IMPLEMENT USING THE RIGHT CAPABILITY NAME */ 
	...
	*/
	...
	@Produces(Array(MediaType.WILDCARD,"application/x-javascript"))
	//#SWG#@ApiOperation(value = "/thumbnail", notes = """This service provides the thumbnail of a given content with the desired resolution and quality: THRON will automatically process the highest available quality image to apply cropping and resize algorithms that match your request, as specified by URL parameters expressed after ContentID. 
	//#SWGNL#For backward compatibility, if no additional query param is provided, the service will return the image of the exact width of the divArea while height will respect the aspect ratio.
	//#SWGNL#HTTP status codes: 
	//#SWGNL#<ul>
	//#SWGNL#	<li>400: invalid arguments, </li>
	...
	croph: Double,
		...
		try{	
			val resp = this.__thumbnail(PRestHelper.getTokenId(tokenId_q, tokenId),clientId,id,pkey,preset,divArea,prettyName,lcid,scalemode,quality,cropmode,cropx,cropy,cropw,croph)
	...
	/** ABSTRACT METHOD TO IMPLEMENT */ 
	 protected def __thumbnail(tokenId: String, clientId: String, id: String, pkey: String, preset: String, divArea: String, prettyName: String, lcid: String, scalemode: String, quality: Integer, cropmode: String, cropx: Double, cropy: Double, cropw: Double, croph: Double) :java.io.File
	/** ABSTRACT METHOD. IMPLEMENT USING THE RIGHT CAPABILITY NAME */ 
