 ...
 * </ul>
 */
class JPublicClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def url(tokenId: String, 
			...
			pkey: String, 
			prettyName: String, 
			lcid: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):java.io.File ={
	...
	*/
	def image(tokenId: String, 
			...
			placeholderPkey: String)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):java.io.File ={
		...
		Option(placeholderId).foreach(s => params.add("placeholderId", s))
		Option(placeholderPkey).foreach(s => params.add("placeholderPkey", s))
			val response : java.io.File = if(this.resourceEndpoint == ""){
	...
	*/
	 ...
	 * @return java.io.File
	*/
	def productThumbnail(tokenId: String, 
			clientId: String, 
			id: String, 
			pkey: String, 
			preset: String, 
