...
class MSynclastUpdatedContentsReq extends Serializable {
	...
	def withclientId(p:String):MSynclastUpdatedContentsReq ={ 	this.clientId = p; 	this }
	...
	@BeanProperty
	var fromDate: Date =_
	def withfromDate(p:Date):MSynclastUpdatedContentsReq ={ 	this.fromDate = p; 	this }
	...
	@BeanProperty
	var toDate: Date =_
	def withtoDate(p:Date):MSynclastUpdatedContentsReq ={ 	this.toDate = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var offset: Integer =_
	def withoffset(p:Integer):MSynclastUpdatedContentsReq ={ 	this.offset = p; 	this }
	...
	def withnumberOfResults(p:Integer):MSynclastUpdatedContentsReq ={ 	this.numberOfResults = p; 	this }
