...
import it.newvision.nvp.webtv.services.model.sync.MUpdatedContentCriteria
...
****************************/
/**
 * Request message for service JSync.updatedContent
 */
@XmlRootElement(name="MSyncupdatedContentReq")
@XmlType(name="MSyncupdatedContentReq")
//#SWG#@ApiModel(description = "Request message for service JSync.updatedContent")
class MSyncupdatedContentReq extends Serializable {
	...
	@BeanProperty
	var criteria: MUpdatedContentCriteria =_
	def withcriteria(p:MUpdatedContentCriteria):this.type ={ 	this.criteria = p; 	this }
	...
	//#SWGNL#If the value is empty, the service will return the 1st page of the resultset.""", required = true)
	@BeanProperty
