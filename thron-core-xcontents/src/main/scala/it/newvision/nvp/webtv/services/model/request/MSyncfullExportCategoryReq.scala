...
import it.newvision.nvp.webtv.services.model.sync.MSyncFullExportCategoryCriteria
...
****************************/
/**
 * Request message for service JSync.fullExportCategory
 */
@XmlRootElement(name="MSyncfullExportCategoryReq")
@XmlType(name="MSyncfullExportCategoryReq")
//#SWG#@ApiModel(description = "Request message for service JSync.fullExportCategory")
class MSyncfullExportCategoryReq extends Serializable {
	...
	@BeanProperty
	var criteria: MSyncFullExportCategoryCriteria =_
	def withcriteria(p:MSyncFullExportCategoryCriteria):this.type ={ 	this.criteria = p; 	this }
