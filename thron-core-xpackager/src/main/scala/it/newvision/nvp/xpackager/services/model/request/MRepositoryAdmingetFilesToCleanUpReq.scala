...
class MRepositoryAdmingetFilesToCleanUpReq extends Serializable {
	...
	def withsiteName(p:String):MRepositoryAdmingetFilesToCleanUpReq ={ 	this.siteName = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty
	var numberOfResults: Integer =_
	def withnumberOfResults(p:Integer):MRepositoryAdmingetFilesToCleanUpReq ={ 	this.numberOfResults = p; 	this }
