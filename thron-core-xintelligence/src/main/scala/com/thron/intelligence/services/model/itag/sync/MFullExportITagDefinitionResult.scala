...
****************************/
@XmlRootElement(name="MFullExportITagDefinitionResult") 
@XmlType(name="MFullExportITagDefinitionResult")
//#SWG#@ApiModel(description = """""")
class MFullExportITagDefinitionResult extends Serializable {
