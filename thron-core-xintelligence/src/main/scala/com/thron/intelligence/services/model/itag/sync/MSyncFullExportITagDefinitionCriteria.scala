 ...
 * </ul>
 */
@XmlRootElement(name="MSyncFullExportITagDefinitionCriteria") 
@XmlType(name="MSyncFullExportITagDefinitionCriteria")
...
//#SWGNL#</ul>""")
class MSyncFullExportITagDefinitionCriteria extends Serializable {
