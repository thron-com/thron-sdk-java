 ...
 * </ul>
 */
class JIMetadataClient(val resourceEndpoint:String, defaultHeader:Option[scala.collection.Map[String,String]]=None) {
	...
	*/
	def insert(tokenId: String, 
			...
			param: MIMetadatainsertReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseIMetadata ={
	...
	*/
	def remove(tokenId: String, 
			...
			classificationId: String, 
			key: String, 
			param: MIMetadataremoveReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseIMetadata ={
	...
	*/
	def update(tokenId: String, 
			clientId: String, 
			classificationId: String, 
			param: MIMetadataupdateReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseIMetadata ={
	...
	*/
	def bulkInsert(tokenId: String, 
			clientId: String, 
			classificationId: String, 
			param: MIMetadatabulkInsertReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseIMetadataBulk ={
	...
	*/
	def bulkRemove(tokenId: String, 
			clientId: String, 
			classificationId: String, 
			param: MIMetadatabulkRemoveReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseIMetadataBulk ={
	...
	*/
	def bulkInsertMultiTargets(tokenId: String, 
			clientId: String, 
			classificationId: String, 
			param: MIMetadatabulkInsertMultiTargetsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseIMetadataBulk2 ={
	...
	*/
	def bulkRemoveMultiTargets(tokenId: String, 
			clientId: String, 
			classificationId: String, 
			param: MIMetadatabulkRemoveMultiTargetsReq)(implicit _fwdHeaders:Option[scala.collection.Map[String,String]]=defaultHeader):MResponseIMetadataBulk2 ={
