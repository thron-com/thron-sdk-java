...
****************************/
/**
 * Request message for service JIMetadata.update
 */
@XmlRootElement(name="MIMetadataupdateReq")
@XmlType(name="MIMetadataupdateReq")
//#SWG#@ApiModel(description = "Request message for service JIMetadata.update")
class MIMetadataupdateReq extends Serializable {
	...
	def withimetadata(p:MIMetadata):MIMetadataupdateReq ={ 	this.imetadata = p; 	this }
	...
	def withtarget(p:MTarget):MIMetadataupdateReq ={ 	this.target = p; 	this }
