...
****************************/
@XmlRootElement(name="MMetadataDefinitionBooleanOption") 
@XmlType(name="MMetadataDefinitionBooleanOption")
//#SWG#@ApiModel(description = """""")
class MMetadataDefinitionBooleanOption extends MMetadataDefinitionOptionClass with Serializable  {
