 ...
 * The user can define multiple external Id for the same ITagDefinition.
 * Consists of a key field and a value separated by a colon (id:  <key>:<value>)
 * The value only could be not unique, so the user can specify the an
 * identification label on the key field.
 * 
 * <b>Examples:</b>
 * <ul>
 * 	<li>crm:business</li>
...
//#SWGNL#The user can define multiple external Id for the same ITagDefinition.
//#SWGNL#Consists of a key field and a value separated by a colon (id:  <key>:<value>)
//#SWGNL#The value only could be not unique, so the user can specify the an identification label on the key field.
//#SWGNL#
//#SWGNL#<b>Examples:</b>
//#SWGNL#<ul>
