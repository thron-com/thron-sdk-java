...
class MTestServicetestPcontentReq extends Serializable {
	...
	def withclientId(p:String):MTestServicetestPcontentReq ={ 	this.clientId = p; 	this }

	//#SWG#@ApiModelProperty(value = """""", required = true)
	@BeanProperty @org.codehaus.jackson.annotate.JsonProperty("PContentId")
	var pContentId: String =_
	def withpContentId(p:String):MTestServicetestPcontentReq ={ 	this.pContentId = p; 	this }
