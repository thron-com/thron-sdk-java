...
****************************/
/**
 * Request message for service JContact.insertTags
 */
@XmlRootElement(name="MContactinsertTagsReq")
@XmlType(name="MContactinsertTagsReq")
//#SWG#@ApiModel(description = "Request message for service JContact.insertTags")
class MContactinsertTagsReq extends Serializable {
