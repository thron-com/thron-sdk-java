...
****************************/
/**
 * Request message for service JITag.removeITags
 */
@XmlRootElement(name="MITagremoveITagsReq")
@XmlType(name="MITagremoveITagsReq")
//#SWG#@ApiModel(description = "Request message for service JITag.removeITags")
class MITagremoveITagsReq extends Serializable {
